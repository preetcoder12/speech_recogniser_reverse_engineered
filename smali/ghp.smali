...
# instance fields
.field final synthetic d:Lcom/google/audio/hearing/visualization/accessibility/scribe/saving/TranscriptRoomDatabase_Impl;


# direct methods
.method public constructor <init>(Lcom/google/audio/hearing/visualization/accessibility/scribe/saving/TranscriptRoomDatabase_Impl;)V
    .locals 2

    .line 1
    iput-object p1, p0, Lghp;->d:Lcom/google/audio/hearing/visualization/accessibility/scribe/saving/TranscriptRoomDatabase_Impl;

    .line 2
    .line 3
    const-string p1, "e0d247f646610b867c2fc21e81cacc28"

    .line 4
    .line 5
    const-string v0, "c8c3b25337466da1d338ec4681732670"
...
.method public final a(Lbvx;)V
    ...
    .line 1
    const-string p0, "CREATE TABLE IF NOT EXISTS `transcripts` (`transcript` TEXT, `id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `uuid` TEXT NOT NULL, `name` TEXT, `duration_millis` INTEGER NOT NULL, `time` INTEGER NOT NULL, `julian_day` INTEGER NOT NULL, `time2445` TEXT, `timezone` TEXT, `starred` INTEGER NOT NULL, `segment_uuid` TEXT, `is_temporary` INTEGER NOT NULL)"
    ...
    .line 5
    .line 6
    const-string p0, "CREATE UNIQUE INDEX IF NOT EXISTS `uuidIndex` ON `transcripts` (`uuid`)"
    ...
    .line 10
    .line 11
    const-string p0, "CREATE TABLE IF NOT EXISTS `recent_search` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `time` INTEGER NOT NULL, `timezone` TEXT, `query_text` TEXT NOT NULL)"
    ...
    .line 15
    .line 16
    const-string p0, "CREATE UNIQUE INDEX IF NOT EXISTS `queryTextIndex` ON `recent_search` (`query_text`)"
    ...
    .line 20
    .line 21
    const-string p0, "CREATE TABLE IF NOT EXISTS `bias_word` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `text` TEXT NOT NULL, `biasWordType` INTEGER NOT NULL)"
    ...
    .line 25
    .line 26
    const-string p0, "CREATE UNIQUE INDEX IF NOT EXISTS `biasWordIndex` ON `bias_word` (`text`, `biasWordType`)"
    ...
    .line 30
    .line 31
    const-string p0, "CREATE TABLE IF NOT EXISTS `bias_word_log` (`text` TEXT NOT NULL, `is_triggered_by` INTEGER NOT NULL, `event_time` INTEGER NOT NULL, `julian_day` INTEGER NOT NULL, PRIMARY KEY(`text`, `is_triggered_by`))"
    ...
    .line 40
    .line 41
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'e0d247f646610b867c2fc21e81cacc28\')"
...
.method public final b(Lbvx;)V
    ...
    .line 1
    const-string p0, "DROP TABLE IF EXISTS `transcripts`"
    ...
    .line 10
    .line 11
    const-string p0, "DROP TABLE IF EXISTS `bias_word`"
    ...
    .line 15
    .line 16
    const-string p0, "DROP TABLE IF EXISTS `bias_word_log`"
...
.method public final c(Lbvx;)V
    ...
    .line 1
    iget-object p0, p0, Lghp;->d:Lcom/google/audio/hearing/visualization/accessibility/scribe/saving/TranscriptRoomDatabase_Impl;
...
.method public final g(Lbvx;)Ljfy;
    ...
    .line 266
    const-string v14, "uuidIndex"

    .line 267
    .line 268
    invoke-direct {v11, v14, v10, v3, v13}, Lbus;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    ...
    .line 275
    .line 276
    const-string v11, "transcripts"

    .line 277
    .line 278
    invoke-direct {v3, v11, v1, v7, v9}, Lbut;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V

    .line 279
    .line 280
    .line 281
    invoke-static {v0, v11}, Lbkc;->i(Lbvx;Ljava/lang/String;)Lbut;
    ...
    .line 285
    invoke-static {v3, v1}, Lble;->o(Lbut;Ljava/lang/Object;)Z
    ...
    .line 292
    .line 293
    const-string v2, "transcripts(com.google.audio.hearing.visualization.accessibility.scribe.saving.TranscriptEntity).\n Expected:\n"

    .line 294
    .line 295
    invoke-static {v1, v3, v2}, Lcqb;->d(Lbut;Lbut;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 417
    const-string v13, "queryTextIndex"

    .line 418
    .line 419
    invoke-direct {v9, v13, v10, v6, v11}, Lbus;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    ...
    .line 426
    .line 427
    const-string v9, "recent_search"

    .line 428
    .line 429
    invoke-direct {v6, v9, v1, v4, v7}, Lbut;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
    ...
    .line 443
    .line 444
    const-string v2, "recent_search(com.google.audio.hearing.visualization.accessibility.scribe.saving.RecentSearchEntity).\n Expected:\n"

    .line 445
    .line 446
    invoke-static {v1, v6, v2}, Lcqb;->d(Lbut;Lbut;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 550
    const-string v12, "biasWordIndex"

    .line 551
    .line 552
    invoke-direct {v9, v12, v10, v4, v11}, Lbus;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    ...
    .line 559
    .line 560
    const-string v9, "bias_word"

    .line 561
    .line 562
    invoke-direct {v4, v9, v1, v6, v7}, Lbut;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Set;Ljava/util/Set;)V
    ...
    .line 576
    .line 577
    const-string v2, "bias_word(com.google.audio.hearing.visualization.accessibility.scribe.saving.BiasWordEntity).\n Expected:\n"

    .line 578
    .line 579
    invoke-static {v1, v4, v2}, Lcqb;->d(Lbut;Lbut;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 615
    .line 616
    const-string v13, "is_triggered_by"
    ...
    .line 624
    .line 625
    const-string v2, "is_triggered_by"
    ...
    .line 700
    .line 701
    const-string v2, "bias_word_log(com.google.audio.hearing.visualization.accessibility.scribe.saving.BiasWordLogEntity).\n Expected:\n"
    ...
    .line 707
    invoke-direct {v1, v8, v0}, Ljfy;-><init>(ZLjava/lang/String;)V
    ...
    .line 714
    invoke-direct {v0, v10, v1}, Ljfy;-><init>(ZLjava/lang/String;)V
