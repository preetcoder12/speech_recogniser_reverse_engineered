...
.method public final a(Lbvg;)V
    ...
    .line 8
    .line 9
    const-string v2, "com/google/audio/hearing/visualization/accessibility/scribe/saving/TranscriptRoomDatabaseMigrations$2"
    ...
    .line 20
    .line 21
    const-string v1, "Migrating from database schema v2 to v3."
    ...
    .line 28
    .line 29
    const-string v0, "CREATE TABLE IF NOT EXISTS recent_search (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, time INTEGER NOT NULL, timezone TEXT, query_text TEXT NOT NULL)"
    ...
    .line 33
    .line 34
    const-string v0, "CREATE UNIQUE INDEX IF NOT EXISTS queryTextIndex ON recent_search (query_text)"
    ...
    .line 56
    .line 57
    const-string p1, "Migrating from database schema v2 to v3 ended."
